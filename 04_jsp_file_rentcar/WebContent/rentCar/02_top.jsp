...
%>
	<table>
		<tr height="70">
			...
			<td align="center" width="200">
				...
				<%
					if(id.equals("GUEST")){
				%>
				<button onclick="location.href='01_main.jsp?center=05_memberLogin.jsp'">로그인</button>
				<%}else{ %>
		...
		<tr height="50">
			...
			<td align="center" width="200" bgcolor="pink">
				<font color="white" size="5"><a href="01_main.jsp?center=16_board.jsp" style="text-decoration: none">자유게시판</a></font>
			</td>
			<td align="center" width="200" bgcolor="pink">
